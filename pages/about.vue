...
<!--    </div>-->
  ...
  <section class="my-12 container">
    <div class="w-10/12 mx-auto">
      <div class="grid grid-cols-2 items-center justify-center gap-24">
        <div class="">
    ...
    <div class="container grid grid-cols-12 py-12">
      <div class="col-span-3">
        ...
        <ul class="list-disc list-inside">
          ...
          <li>9000 + GOTOLATAM GUESTS</li>
          <li>30000 + FACEBOOK FOLLOWERS</li>
          <li>Viaja con un equipo galardonado</li>
          <li>#Gotolatam Tag us on Instagram</li>
        </ul>
      </div>
