<template>
  <header class="h-[60vh] relative">
    <img src="https://gotoperu.com/images/team/banner3.jpg" alt="" class="object-cover w-screen h-full">
  ...
  <section>
    <div class="container grid grid-cols-12 py-12 gap-12 items-center">
