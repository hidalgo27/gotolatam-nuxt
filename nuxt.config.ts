...
export default defineNuxtConfig({
  ...
  modules: [// needed
    '@pinia/nuxt', '@pinia-plugin-persistedstate/nuxt', "@nuxt/image", "@nuxtjs/google-fonts", 'floating-vue/nuxt', '@hypernym/nuxt-gsap', '@nuxt/scripts', '@samk-dev/nuxt-vcalendar', '@nuxtjs/device'],
  // gsap: {
  //   composables: true,
  //   provide: false,
  // },
  ...
  runtimeConfig: {
    apiSecret: '',
    public: {
      apiBase: process.env.NUXT_PUBLIC_API_BASE || "https://api.gotolatam.travel/api",
